...
1. for class Class object will be created while calling getClass() method of object class.
...
4. while calling getClass() method it returns an object to the particular class.
   Inside this class there are several getter methods. Through this getter methods we can identify what are the attributes, what are the methods and what is the class name, Constructors, access levels like several getter methods are there.
